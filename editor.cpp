...
#define THEME_FIELD_COUNT (sizeof(theme_keys) / sizeof(theme_keys[0]))

static const char *theme_keys[] = {
    "bg", "text", "line_num", "cursor", "title_bar",
    "status_bar", "menu_bg", "menu_border", "menu_selected",
...
static Uint16 *theme_get_field(Theme *t, int index)
{
    switch (index)
    {
    case 0:
